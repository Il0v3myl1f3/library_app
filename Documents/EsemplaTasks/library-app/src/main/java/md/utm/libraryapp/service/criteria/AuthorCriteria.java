...
/**
 * Criteria class for the {@link md.utm.libraryapp.domain.Author} entity. This class is used
 * in {@link md.utm.libraryapp.web.rest.AuthorResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link md.utm.libraryapp.domain.Publisher} entity. This class is used
 * in {@link md.utm.libraryapp.web.rest.PublisherResource} to receive all the possible filtering options from

...
/**
 * Criteria class for the {@link md.utm.libraryapp.domain.Client} entity. This class is used
 * in {@link md.utm.libraryapp.web.rest.ClientResource} to receive all the possible filtering options from
...
public class ClientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, address, phone, distinct);
    }

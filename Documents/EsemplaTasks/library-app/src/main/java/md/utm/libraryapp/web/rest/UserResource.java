...
import java.util.*;
import md.utm.libraryapp.config.Constants;
import md.utm.libraryapp.domain.User;
import md.utm.libraryapp.repository.UserRepository;
import md.utm.libraryapp.security.AuthoritiesConstants;
import md.utm.libraryapp.service.MailService;
import md.utm.libraryapp.service.UserService;
import md.utm.libraryapp.service.dto.AdminUserDTO;
import md.utm.libraryapp.web.rest.errors.BadRequestAlertException;
import md.utm.libraryapp.web.rest.errors.EmailAlreadyUsedException;
import md.utm.libraryapp.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link md.utm.libraryapp.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
